...
func TestSchematicsUtil(t *testing.T) {
	...
	if s[0].String() != "on: 0110000000000000 switches: [0001000000000000 0101000000000000 0010000000000000 0011000000000000 1010000000000000 1100000000000000]" {
		t.Errorf("schematic string mismatch: %s", s[0].String())
	}

	if s[1].String() != "on: 0001000000000000 switches: [1011100000000000 0011000000000000 1000100000000000 1110000000000000 0111100000000000]" {
		t.Errorf("schematic string mismatch: %s", s[1].String())
	}

	if s[2].String() != "on: 0111010000000000 switches: [1111100000000000 1001100000000000 1110110000000000 0110000000000000]" {
